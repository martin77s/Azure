#
# Module manifest for module 'APIManagementTemplate'
#
...
CmdletsToExport = 'Get-ParameterTemplate', 'Get-APIManagementTemplate', 
               'Write-APIManagementTemplates'
